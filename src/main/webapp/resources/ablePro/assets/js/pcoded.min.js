		...
		.ready(
				function() {
					...
					$("#mobile-collapse").on(
							...
							function() {
								if (c > 991) {
									$(".pcoded-navbar:not(.theme-horizontal)")
											.toggleClass("navbar-collapsed")
								}
							});
					$(".mob-toggler")
							.on(
					...
					$(".card-option .close-card").on(
							"click",
							function() {
								var d = $(this);
								d.parents(".card").addClass("anim-close-card");
								d.parents(".card").animate({
									"margin-bottom" : "0",
								});
								setTimeout(function() {
									d.parents(".card").children(".card-block")
											.slideToggle();
									d.parents(".card").children(".card-body")
											.slideToggle();
									d.parents(".card").children(".card-header")
											.slideToggle();
									d.parents(".card").children(".card-footer")
											.slideToggle()
								}, 600);
								setTimeout(function() {
					...
					$(".card-option .reload-card")
							.on(
									...
									function() {
										...
										setTimeout(function() {
											d.parents(".card").children(
													".card-loader").remove();
											d.parents(".card").removeClass(
													"card-load")
										}, 3000)
									});
...
function menuhrres() {
	...
	if (a < 992) {
		setTimeout(function() {
			$(".sidenav-horizontal-wrapper").addClass(
					"sidenav-horizontal-wrapper-dis").removeClass(
					"sidenav-horizontal-wrapper");
			$(".theme-horizontal").addClass("theme-horizontal-dis")
					.removeClass("theme-horizontal")
		}, 400)
	} else {
		setTimeout(function() {
			$(".sidenav-horizontal-wrapper-dis").addClass(
					"sidenav-horizontal-wrapper").removeClass(
					"sidenav-horizontal-wrapper-dis");
			$(".theme-horizontal-dis").addClass("theme-horizontal")
			...
			if (b >= 768) {
				...
				if (a == 400) {
					...
					if (a > ost && 400 < ost) {
						...
						$(".theme-horizontal").addClass("default").removeClass(
								"top-nav-collapse")
					}
				}
				ost = a
	...
	var d = {
		...
		HandleSubMenuTrigger : function() {
			...
			if ($(".pcoded-navbar").hasClass("theme-horizontal") == true
				...
				if ((e >= 992 && $("body").hasClass("layout-6") || (e >= 992 && $(
						"body").hasClass("layout-7")))) {
					...
					f.off("click").off("mouseenter mouseleave").hover(
							function() {
								$(this).addClass("pcoded-trigger").addClass(
										"active")
							},
							function() {
							...
							if (i === 0) {
								if ($(this).hasClass("pcoded-trigger")) {
									...
									$(".pcoded-hasmenu li.pcoded-trigger")
											.children(".pcoded-submenu")
											.slideUp();
									$(this).closest(".pcoded-inner-navbar")
											.find("li.pcoded-trigger")
								...
								if ($(this).hasClass("pcoded-trigger")) {
									...
									$(".pcoded-hasmenu li.pcoded-trigger")
											.children(".pcoded-submenu")
											.slideUp();
									$(this).closest(".pcoded-submenu").find(
											"li.pcoded-trigger").removeClass(
											"pcoded-trigger");
									$(this).addClass("pcoded-trigger");
									$(this).children(".pcoded-submenu")
											.slideDown()
		...
		HandleMenuTrigger : function() {
			...
			if (e >= 992) {
				if ($(".pcoded-navbar").hasClass("theme-horizontal") == true) {
					if ((e >= 768 && $("body").hasClass("layout-6") || (e >= 768 && $(
							"body").hasClass("layout-7")))) {
				...
				var f = $(".pcoded-navbar.theme-horizontal-dis .pcoded-inner-navbar > li");
				f.off("mouseenter mouseleave").off("click").on(
						"click",
						function() {
							if ($(this).hasClass("pcoded-trigger")) {
								$(this).removeClass("pcoded-trigger");
								...
								$("li.pcoded-trigger").children(
										".pcoded-submenu").slideUp();
								$(this).closest(".pcoded-inner-navbar").find(
										"li.pcoded-trigger").removeClass(
										"pcoded-trigger");
								$(this).addClass("pcoded-trigger");
...
$(".pcoded-navbar .pcoded-inner-navbar a").each(
		function() {
			...
			if (!$("body").hasClass("layout-14")) {
				if (this.href == b && $(this).attr("href") != "") {
					...
					if (!$(".pcoded-navbar").hasClass("theme-horizontal")) {
						...
						$(this).parent("li").parent().parent(".pcoded-hasmenu")
								.parent().parent(".pcoded-hasmenu").addClass(
										"active").addClass("pcoded-trigger")
					}
					if ($("body").hasClass("layout-7")
						...
						$(this).parent("li").parent().parent(".pcoded-hasmenu")
								.parent().parent(".pcoded-hasmenu").addClass(
										"active").addClass("pcoded-trigger");
						$(".theme-horizontal .pcoded-inner-navbar").find(
								"li.pcoded-trigger").removeClass(
								"pcoded-trigger")
					}
					$(this).parent("li").parent().parent(".sidelink").addClass(
							"active");
					$(this).parent("li").parent().parent().parent().parent(
							".sidelink").addClass("active");
					$(this).parent("li").parent().parent().parent().parent()
							.parent().parent(".sidelink").addClass("active");
